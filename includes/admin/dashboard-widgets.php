	...
	<div class="give-dashboard-widget">
		...
		<div class="give-dashboard-today give-clearfix">
			...
			<p class="give-dashboard-today-earnings"><?php
				$earnings_today = Give()->donation_stats_db->get_earnings( array( 'date' => 'today' ) );
		...
		<table class="give-table-stats">
			...
			<tr id="give-table-stats-tr-1">
				<td>
					<p class="give-dashboard-stat-total"><?php echo give_currency_filter( give_format_amount( Give()->donation_stats_db->get_earnings( array( 'date' => 'this_week' ) ), array( 'sanitize' => false ) ) ); ?></p>

					<p class="give-dashboard-stat-total-label"><?php _e( 'This Week', 'give' ); ?></p>
				</td>
				<td>
					<p class="give-dashboard-stat-total"><?php echo give_currency_filter( give_format_amount( Give()->donation_stats_db->get_earnings( array( 'date' => 'this_month' ) ), array( 'sanitize' => false ) ) ); ?></p>
			...
			<tr id="give-table-stats-tr-2">
				<td>
					<p class="give-dashboard-stat-total"><?php echo give_currency_filter( give_format_amount( Give()->donation_stats_db->get_earnings( array( 'date' => 'last_month' ) ), array( 'sanitize' => false ) ) ) ?></p>

					<p class="give-dashboard-stat-total-label"><?php _e( 'Last Month', 'give' ); ?></p>
				</td>
				<td>
					<p class="give-dashboard-stat-total"><?php echo give_currency_filter( give_format_amount( Give()->donation_stats_db->get_earnings( array( 'date' => 'this_quarter' ) ), array( 'sanitize' => false ) ) ) ?></p>
